        ...
        \item{Properties of $*$:}
            ...
            \end{minipage}
                ...
                \item Let,
                    \begin{align*}
                        ...
                        x&\in X\\
                    \end{align*}
                    \underline{Definition:} A \underline{loop} in $X$ based at $x\in X$ is a path,
                    \begin{align*}
                        f:I&\rightarrow X\\
                        \text{such that}
                        &f(0)=f(1)\\
            ...
            \end{minipage}
                \item \underline{Observation:} If $f$ and $g$ are any two loops in $X$ based at $x$,
                    then $f*g$ is a loop.
                \item \underline{Definition:} The \underline{fundamental group} of the $X$ with basepoint $x$ is:
                    \begin{align*}
